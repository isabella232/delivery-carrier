...
def send_shipping(self, pickings):
    # Fake method bound dynamically to the carriers (monkey-patch)
    # to get a delivery costs working without configuring a provider etc
...
class TestDeliverySendToShipper(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.carrier_on_ship.__class__.send_shipping = types.MethodType(
            send_shipping, cls.carrier_on_ship
        )
        ...
        cls.carrier_on_pack.__class__.send_shipping = types.MethodType(
            send_shipping, cls.carrier_on_pack
        )
