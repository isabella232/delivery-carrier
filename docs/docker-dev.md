...
1. Clone the project
        ...
        git clone git@github.com:camptocamp/swisslux_odoo.git swisslux_odoo
...
docker exec -ti swisslux_odoo_db_1 psql -U odoo odoodb
# run bash in the running odoo container
docker exec -ti swisslux_odoo_1 bash
```
